...
class BaseSudokuSolver:
    ...
    Methods:
        solve(self, grid): Solve the Sudoku puzzle.
        ...
        find_empty_cell(self): Return the (row, column) of
            the first empty cell in the grid.
...
class BaseBruteforceSudokuSolver(BaseSudokuSolver):
    ...
    Methods:
        ...
        Additional methods:
            find_empty_cells(self): Return (row, col) for all
            ...
            verify_grid(self): Verify if all values in the grid
                are unique in each row, column, and block. Returns True
